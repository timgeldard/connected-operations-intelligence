...
CREATE OR REPLACE VIEW connected_plant_dev.gold_io_reporting.gold_stock_holds_live AS
SELECT
  b.*,
...
FROM connected_plant_dev.gold_io_reporting.gold_stock_holds_secured AS b;
GRANT SELECT ON VIEW connected_plant_dev.gold_io_reporting.gold_stock_holds_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_dev.gold_io_reporting.gold_transfer_order_open_items_live AS
SELECT
  b.*,
...
FROM connected_plant_dev.gold_io_reporting.gold_transfer_order_open_items_secured AS b;
GRANT SELECT ON VIEW connected_plant_dev.gold_io_reporting.gold_transfer_order_open_items_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_dev.gold_io_reporting.gold_transfer_requirement_open_items_live AS
SELECT
  b.*,
  CASE WHEN b.created_datetime IS NOT NULL THEN (unix_timestamp(current_timestamp()) - unix_timestamp(b.created_datetime)) / 3600.0 END AS age_hours
FROM connected_plant_dev.gold_io_reporting.gold_transfer_requirement_open_items_secured AS b;
GRANT SELECT ON VIEW connected_plant_dev.gold_io_reporting.gold_transfer_requirement_open_items_live TO `users`;
...
CREATE OR REPLACE VIEW connected_plant_dev.gold_io_reporting.gold_wm_inbound_deliveries_live AS
SELECT
  b.*,
...
FROM connected_plant_dev.gold_io_reporting.gold_wm_inbound_deliveries_secured AS b;
GRANT SELECT ON VIEW connected_plant_dev.gold_io_reporting.gold_wm_inbound_deliveries_live TO `users`;
...
CREATE OR REPLACE VIEW connected_plant_dev.gold_io_reporting.gold_wm_lineside_now_live AS
SELECT
  b.*,
...
FROM connected_plant_dev.gold_io_reporting.gold_wm_lineside_now_secured AS b;
GRANT SELECT ON VIEW connected_plant_dev.gold_io_reporting.gold_wm_lineside_now_live TO `users`;
