-- WM Operations Consumption Views (UAT)
...
-- Run once as a UC admin AFTER gold_security_uat.sql and gold_serving_views_uat.sql.
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_staging_worklist_live
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_worklist_summary_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  readiness_reason,
  production_line
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_readiness_live
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  days_to_expiry,
  is_expired
FROM connected_plant_uat.gold_io_reporting.gold_wm_bin_stock_detail_live
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  psa_supplied_qty,
  is_supplied
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_component_detail_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  confirmed_qty
FROM connected_plant_uat.gold_io_reporting.gold_wm_operator_activity_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  CAST(earliest_planned_datetime AS TIMESTAMP) AS earliest_planned_ts,
  CAST(earliest_created_datetime AS TIMESTAMP) AS earliest_created_ts
FROM connected_plant_uat.gold_io_reporting.gold_wm_queue_workload_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  delta_value
FROM connected_plant_uat.gold_io_reporting.gold_reconciliation_alerts_secured
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_handling_unit_summary_secured
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_stock_reconciliation_exceptions_v2_secured
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_stock_value_reconciliation_secured
WHERE plant_code IS NOT NULL;
...
SELECT plant_code AS plant_id, warehouse_number AS warehouse_id,
  ...
  CAST(earliest_planned_datetime AS TIMESTAMP) AS earliest_planned_ts,
  CAST(earliest_created_datetime AS TIMESTAMP) AS earliest_created_ts
FROM connected_plant_uat.gold_io_reporting.gold_wm_campaign_summary_secured
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_daily_activity_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  is_confirmed
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_operations_secured
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_downtime_pareto_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  receipt_band
FROM connected_plant_uat.gold_io_reporting.gold_wm_inbound_deliveries_live
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_journey_summary_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  reference_id,
  detail
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_journey_events_secured
WHERE plant_code IS NOT NULL;
...
SELECT
  ...
  CAST(first_gr_posting_date AS DATE) AS first_gr_posting_date,
  gr_qty
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_wip_stage_secured
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_process_order_schedule_adherence_secured
WHERE plant_code IS NOT NULL
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_yield_secured
WHERE plant_code IS NOT NULL;
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_recipe_run_benchmark_secured
WHERE plant_code IS NOT NULL;
...
-- ⚠️ Data scope ≤ 2023-12-05 in UAT bronze (UAT-snapshot artefact). Prod data is current.
...
SELECT
  ...
  CASE
    ...
    ELSE NULL
  END                                                    AS days_overdue
FROM connected_plant_uat.gold_io_reporting.gold_wm_push_despatch_delivery_secured d
...
SELECT
  ...
  agg.on_time_pgi_pct
FROM connected_plant_uat.gold_io_reporting.gold_wm_push_despatch_daily_secured agg
