-- Unity Catalog Gold 'live' serving views (UAT).
...
CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_stock_holds_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_stock_holds_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_stock_holds_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_transfer_order_open_items_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_transfer_order_open_items_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_transfer_order_open_items_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_transfer_requirement_open_items_live AS
SELECT
  b.*,
  CASE WHEN b.created_datetime IS NOT NULL THEN (unix_timestamp(current_timestamp()) - unix_timestamp(b.created_datetime)) / 3600.0 END AS age_hours
FROM connected_plant_uat.gold_io_reporting.gold_transfer_requirement_open_items_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_transfer_requirement_open_items_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_lineside_stock_live AS
SELECT
  b.*,
  CASE WHEN b.earliest_expiry_date IS NOT NULL THEN datediff(b.earliest_expiry_date, current_date()) END AS min_days_to_expiry
FROM connected_plant_uat.gold_io_reporting.gold_lineside_stock_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_lineside_stock_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_delivery_pick_status_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_process_order_staging_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_process_order_staging_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_stock_expiry_risk_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_stock_expiry_risk_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_stock_expiry_risk_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_inbound_po_backlog_enhanced_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_inbound_po_backlog_enhanced_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_inbound_po_backlog_enhanced_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_inbound_po_line_backlog_live AS
SELECT
  b.*,
...
CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_staging_worklist_live AS
SELECT
  b.*,
  CASE WHEN b.created_datetime IS NOT NULL THEN (unix_timestamp(current_timestamp()) - unix_timestamp(b.created_datetime)) / 3600.0 END AS age_hours,
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_staging_worklist_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_staging_worklist_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_order_readiness_live AS
SELECT
  b.*,
  datediff(b.scheduled_start_date, current_date()) AS days_to_start,
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_order_readiness_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_order_readiness_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_bin_stock_detail_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_bin_stock_detail_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_bin_stock_detail_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_slow_movers_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_slow_movers_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_slow_movers_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_qm_lot_status_live AS
SELECT
  b.*,
...
FROM connected_plant_uat.gold_io_reporting.gold_wm_qm_lot_status_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_qm_lot_status_live TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_qm_disposition_queue_live AS
SELECT
  b.*,
  CASE WHEN b.lot_created_date IS NOT NULL THEN datediff(current_date(), b.lot_created_date) END AS lot_age_days,
  b.inspection_end_date IS NOT NULL AND b.inspection_end_date < current_date() AS is_overdue
FROM connected_plant_uat.gold_io_reporting.gold_wm_qm_disposition_queue_secured AS b;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_qm_disposition_queue_live TO `users`;
