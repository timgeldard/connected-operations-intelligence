-- Quality Lab Board Consumption Views (PROD)
...
FROM connected_plant_prod.gold_io_reporting.gold_qm_lab_result_signal_secured
WHERE plant_code IS NOT NULL;

GRANT SELECT ON VIEW connected_plant_prod.gold_io_reporting.vw_consumption_quality_lab_fails TO `users`;
