...
-- Target Schema: connected_plant_prod.gold_io_reporting
...
SELECT
  ...
  bins_total,
  bin_util_pct
FROM connected_plant_prod.gold_io_reporting.gold_kpi_snapshot_v_live; -- TODO: Verify source table exists and has _live view
...
FROM connected_plant_prod.gold_io_reporting.gold_inbound_po_backlog_enhanced_live;
...
FROM connected_plant_prod.gold_io_reporting.gold_transfer_requirement_backlog;
