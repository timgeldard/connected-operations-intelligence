...
-- Target Schema: connected_plant_dev.gold_dev
...
SELECT
  ...
  bins_total,
  bin_util_pct
FROM connected_plant_dev.gold_dev.gold_kpi_snapshot_v_live; -- TODO: Verify source table exists and has _live view
...
SELECT
  ...
  detail_text,
  detected_date
FROM connected_plant_dev.gold_dev.gold_warehouse_exceptions;
