...
CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_daily_activity_baseline_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_wm_daily_activity_baseline;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_daily_activity_baseline_secured TO `users`;
...
CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_order_yield_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_wm_order_yield;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_order_yield_secured TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_recipe_run_benchmark_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_wm_recipe_run_benchmark;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_wm_recipe_run_benchmark_secured TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_wm_order_component_variance_secured AS
...
CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_qm_characteristic_pareto_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_qm_characteristic_pareto;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_qm_characteristic_pareto_secured TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_qm_ud_code_pareto_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_qm_ud_code_pareto;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_qm_ud_code_pareto_secured TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_risk_reason_taxonomy_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_risk_reason_taxonomy;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_risk_reason_taxonomy_secured TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_operational_risk_item_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_operational_risk_item;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_operational_risk_item_secured TO `users`;

CREATE OR REPLACE VIEW connected_plant_uat.gold_io_reporting.gold_domain_freshness_watermark_secured AS
  SELECT * FROM connected_plant_uat.gold_io_reporting.gold_domain_freshness_watermark;
GRANT SELECT ON VIEW connected_plant_uat.gold_io_reporting.gold_domain_freshness_watermark_secured TO `users`;
