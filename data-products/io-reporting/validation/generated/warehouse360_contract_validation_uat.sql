...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_overview
-- Grain: one row per plant_id + snapshot timestamp
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_overview;

SELECT
  'vw_consumption_warehouse360_overview' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_overview;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_inbound_backlog
-- Grain: one row per plant_id + po_id + po_item
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_inbound_backlog;

SELECT
  'vw_consumption_warehouse360_inbound_backlog' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_inbound_backlog;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_outbound_backlog
-- Grain: one row per plant_id and delivery ID
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_outbound_backlog;

SELECT
  'vw_consumption_warehouse360_outbound_backlog' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_outbound_backlog;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_staging_workload
-- Grain: one row per plant_id and process order (order grain — first wave)
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_staging_workload;

SELECT
  'vw_consumption_warehouse360_staging_workload' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_staging_workload;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_stock_exceptions
-- Grain: one row per plant_id, material_id, batch_id, and exception type
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_stock_exceptions;

SELECT
  'vw_consumption_warehouse360_stock_exceptions' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_stock_exceptions;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_shortfalls
-- Grain: one row per plant_id and material_id
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_shortfalls;

SELECT
  'vw_consumption_warehouse360_shortfalls' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_shortfalls;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_im_wm_reconciliation
-- Grain: one row per plant_id, material_id, batch_id, and exception type (aggregate exception summary)
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_im_wm_reconciliation;

SELECT
  'vw_consumption_warehouse360_im_wm_reconciliation' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_im_wm_reconciliation;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_open_holds
-- Grain: one row per plant_id + warehouse_number + quant under hold
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_open_holds;

SELECT
  'vw_consumption_warehouse360_open_holds' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_open_holds;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_pick_tasks
-- Grain: one row per warehouse_number + task_id + item_number (open TO items)
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_pick_tasks;

SELECT
  'vw_consumption_warehouse360_pick_tasks' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_pick_tasks;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_move_requests
-- Grain: one row per warehouse_number + request_id + item_number (open TR items)
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_move_requests;

SELECT
  'vw_consumption_warehouse360_move_requests' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_move_requests;
...
-- View: connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_goods_movements
-- Grain: one row per document_number + fiscal_year + line_item (MSEG line)
-- ============================================================================

DESCRIBE TABLE connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_goods_movements;

SELECT
  'vw_consumption_warehouse360_goods_movements' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_uat.gold_io_reporting.vw_consumption_warehouse360_goods_movements;
