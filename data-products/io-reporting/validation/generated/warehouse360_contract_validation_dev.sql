...
-- View: connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_open_holds
-- Grain: one row per plant_id + warehouse_number + quant under hold
-- ============================================================================

DESCRIBE TABLE connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_open_holds;

SELECT
  'vw_consumption_warehouse360_open_holds' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_open_holds;
...
-- View: connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_pick_tasks
-- Grain: one row per warehouse_number + task_id + item_number (open TO items)
-- ============================================================================

DESCRIBE TABLE connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_pick_tasks;

SELECT
  'vw_consumption_warehouse360_pick_tasks' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_pick_tasks;
...
-- View: connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_move_requests
-- Grain: one row per warehouse_number + request_id + item_number (open TR items)
-- ============================================================================

DESCRIBE TABLE connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_move_requests;

SELECT
  'vw_consumption_warehouse360_move_requests' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_move_requests;
...
-- View: connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_goods_movements
-- Grain: one row per document_number + fiscal_year + line_item (MSEG line)
-- ============================================================================

DESCRIBE TABLE connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_goods_movements;

SELECT
  'vw_consumption_warehouse360_goods_movements' AS view_name,
  COUNT(*) AS row_count
FROM connected_plant_dev.gold_io_reporting.vw_consumption_warehouse360_goods_movements;
