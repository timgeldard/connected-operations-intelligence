...
REVOKE SELECT ON TABLE connected_plant_uat.gold.gold_stock_value_reconciliation FROM `users`;
REVOKE SELECT ON TABLE connected_plant_uat.gold.gold_reconciliation_audit_log FROM `users`;
REVOKE SELECT ON TABLE connected_plant_uat.gold.gold_movement_reconciliation FROM `users`;
REVOKE SELECT ON TABLE connected_plant_uat.gold.gold_hu_reconciliation FROM `users`;
REVOKE SELECT ON TABLE connected_plant_uat.gold.gold_physical_inventory_recon FROM `users`;
REVOKE SELECT ON TABLE connected_plant_uat.gold.gold_reconciliation_alerts FROM `users`;
