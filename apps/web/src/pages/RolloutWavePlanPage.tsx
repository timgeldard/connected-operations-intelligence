...
const ROLLOUT_WAVES: readonly RolloutWave[] = [
  {
    ...
    targetWorkspaces: ['quality-batch-release', 'trace-investigation', 'warehouse-360-overview'],
    prerequisites: [],
  ...
  },
  {
    ...
    targetPlants: ['IE10 — Kerry Listowel'],
    targetWorkspaces: ['quality-batch-release', 'trace-investigation', 'warehouse-360-overview', 'spc-monitoring', 'process-order-review'],
