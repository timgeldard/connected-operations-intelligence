...
const SIGNOFFS: readonly StakeholderSignoff[] = [
  {
    ...
    workspaceIds: ['quality-batch-release', 'trace-investigation', 'spc-monitoring'],
    status: 'requested',
  ...
  },
  {
    ...
    workspaceIds: ['trace-investigation', 'quality-batch-release'],
    status: 'requested',
  ...
  },
  {
    ...
    workspaceIds: ['trace-investigation', 'quality-batch-release', 'spc-monitoring', 'process-order-review', 'warehouse-360-overview'],
    status: 'in-progress',
