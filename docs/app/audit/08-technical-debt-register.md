...
| TD-020 | Scope autoElevate order is hardcoded in product-model | Low | Configuration | `packages/domain-models/src/helpers/scope.ts` | `['global', 'region', 'plant', 'line', 'work-centre']` is a hardcoded array, not configurable per deployment. |
